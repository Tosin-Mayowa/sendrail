...
function ShareLink(): JSX.Element {
  ...
  return (
    <Box w="100%" border=" 1px solid #ABA7A7" height="auto" padding="22px" borderRadius="9px">
      <Text fontSize="17px" fontWeight="600">
        Share Link
      </Text>
      <Text fontSize="16px" my="16px">
        Share your logistic imbedded link for customers to be able to onboard directly from you.
      </Text>
      <Text
        width="100%"
        fontWeight="700"
