...
function InTransit(): JSX.Element {
  return (
    <Flex flexDir="column" alignContent="flex-start" m="0px 20px">
      <Text
        fontWeight="700"
        color=" #1F1F1F"
        fontSize="20px"
        ...
        {Array(5)
          ...
          .map((item) => (
            <Box
              ...
              borderRadius="12px"
              key={item}>
              <Flex justifyContent="space-between" alignItems="center" flexWrap="wrap" my="20px">
                <Text fontWeight="600" color=" #000" fontSize="20px">
                  Jon Toe
                </Text>
                <CheckboxGroup colorScheme="#070529">
                  <Stack spacing={["5px", "10px"]} direction={["column", "row"]} fontSize="10px">
              ...
              <Grid w="100%" gridTemplateColumns="6% 54% 6% 28% 6%" my="30px">
                <Image
                  src={Circle}
                  alt="elipse"
                  style={{
                  ...
                  mt="-5px"
                />
                <Image src={LineL} width="100%" height="6px" alt="line" />
                <Image
                  src={Bike}
                  alt="bike"
                  style={{
                  ...
                  mt="-5px"
                />
                <Image src={LineR} alt="line" width="100%" height="6px" />
                <Image
                  src={Flag}
                  alt="flag"
                  style={{
