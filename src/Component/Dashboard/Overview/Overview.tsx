...
function Overview(): JSX.Element {
  ...
  return (
    <Box w="100%" maxH="100vh" overflowY="scroll" className="overview" p="10px">
      <Box fontWeight="600" fontSize="24px" lineHeight="29px" color="#000000" mb="25px">
        Dashboard Overview
      </Box>
      ...
      <Grid w="100%" mt="25px" gridTemplateColumns="65% 35%">
